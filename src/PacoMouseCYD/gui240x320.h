...
enum winObj {WIN_DEFAULT, WIN_LOGO, WIN_CALIBRATE, WIN_THROTTLE, WIN_SSID, WIN_WIFI, WIN_WIFI_PWD, WIN_WIFI_NET_NAME, WIN_WIFI_NET, WIN_PROTOCOL,
             ...
             WIN_AUTOMATION, WIN_AUTO_EDIT, WIN_AUTO_NAME, WIN_AUTO_ADD, WIN_ROUTE_EDIT, WIN_FTP,
             MAX_WIN_OBJ
            };
...
wWinObj winData[MAX_WIN_OBJ] = {
  ...
  { 50, 100, 160, 140, true, COLOR_WHITE, COLOR_BACKGROUND},   // WIN_CHG_FUNC
  ...
  {  0,   0, 240, 320, true, COLOR_BLACK, COLOR_WHITE},        // WIN_AUTOMATION
  {  0,   0, 240, 180, true, COLOR_BLACK, COLOR_BACKGROUND},   // WIN_AUTO_EDIT
  {  0, 125, 240, 195, true, COLOR_WHITE, COLOR_BACKGROUND},   // WIN_AUTO_NAME
  {  0,   0, 240, 320, true, COLOR_BLACK, COLOR_BACKGROUND},   // WIN_AUTO_ADD
  {  0,   0, 240, 140, true, COLOR_WHITE, COLOR_LIGHTGREY},    // WIN_ROUTE_EDIT
  {  0,   0, 240, 320, true, COLOR_WHITE, COLOR_GHOST_WHITE},  // WIN_FTP
};
...
enum labelObj {LBL_PACO_TXT, LBL_INIT, LBL_CONNECT, LBL_PRESS, LBL_CAL, LBL_CAL_DONE,
               ...
               LBL_CV, LBL_LNCV, LBL_POM, LBL_BITS, LBL_CV_ERROR, LBL_UTIL_SPEED, LBL_UTIL_STEAM, LBL_UTIL_SCAN, LBL_UTIL_STA, LBL_UTIL_NXT_TRAIN, LBL_UTIL_REMOTE,
               ...
               LBL_BATT, LBL_CS2_UDP, LBL_CS2_TCP, LBL_CS2_GB, LBL_CS2_ACC, LBL_CS2_UID, LBL_FACTOR, LBL_NXT_TRAIN, LBL_ROUND, LBL_GAME, LBL_NXT_INSTR,
               LBL_FROM, LBL_TO, LBL_ERR_NAME, LBL_MENU_AUTO, LBL_AUTOMATION, LBL_AUTO, LBL_MOMENTARY, LBL_FTP,
               MAX_LABEL_OBJ
              };
...
wLabelObj labelData[MAX_LABEL_OBJ] = {
  ...
  {  45, 220, FSSB9,  COLOR_BLACK,  ML_DATUM},          // LBL_UTIL_REMOTE
  ...
  { 210,  62, FSSB6,  COLOR_BLACK,  MC_DATUM},          // LBL_CS2_UID
  ...
  {  65, 140, FSSB9,  COLOR_BLACK,  ML_DATUM},          // LBL_ERR_NAME
  {  45, 220, FSSB9,  COLOR_WHITE,  ML_DATUM},          // LBL_MENU_AUTO
  {  35,  30, FSSB9,  COLOR_MAROON, ML_DATUM},          // LBL_AUTOMATION
  {  37,  60, FSSB9,  COLOR_NAVY,   MC_DATUM},          // LBL_AUTO
  { 110, 200, FSSB9,  COLOR_NAVY,   ML_DATUM},          // LBL_MOMENTARY
  { 120,  20, FSSB9,  COLOR_DARKRED, MC_DATUM},         // LBL_FTP
};
...
const char drwStrDutch[]     = {"K7S32,24K8r32,24K2R32,8K1y16R32,8s9"};
const char drwStrClock[]     = {"K7C12"};               //{"K7C12K0X97Y138L97,140y6L97,146"};
const char drwStrSelLok[]    = {"K0C21"};     // K10X133Y11R34,26"};
const char drwStrMenu[]      = {"K11L239,40y40L239,80y40L239,120y40L239,160y40L239,200y40L239,240"};
...
const char drwStrAutom[]     = {"K0L239,60y40L239,100y40L239,140y40L239,180y40L239,220y40L239,260X35Y60L35,260X75Y60L75,260"};
const char drwStrFTP[]       = {"K1R230,135K7X35Y215L205,215"};

enum drwStrObj {DSTR_INIT, DSTR_INIT_STAT, DSTR_ENGLISH, DSTR_SPANISH, DSTR_CATALAN, DSTR_GERMAN, DSTR_CZECH, DSTR_FRENCH, DSTR_DUTCH,
                ...
                DSTR_RGB, DSTR_BATT, DSTR_BATT_L, DSTR_BATT_F, DSTR_ORDER, DSTR_AUTO, DSTR_FTP,
                MAX_DRAWSTR_OBJ
               };
...
wDrawStr drawStrData[MAX_DRAWSTR_OBJ] = {
  ...
  {  1,  60, drwStrAutom},                              // DSTR_AUTO
  {  5, 130, drwStrFTP},                                // DSTR_FTP
};
...
enum funcIconObj {  FNC_BLANK_OFF, FNC_BLANK_ON, FNC_NO_ICON_OFF, FNC_NO_ICON_ON, FNC_FUNC_OFF, FNC_FUNC_ON, FNC_LIGHT_OFF, FNC_LIGHT_ON, FNC_INT_LIGHT_OFF, FNC_INT_LIGHT_ON,
                    ...
                    FNC_BRETELLED_OFF, FNC_BRETELLED_ON, FNC_BRETELLE_OFF, FNC_BRETELLE_ON, FNC_SWO_OFF, FNC_SWO_ON, FNC_SWC_OFF, FNC_SWC_ON, FNC_ACC_OFF, FNC_ACC_ON, FNC_SPERR_OFF, FNC_SPERR_ON, FNC_SPERG_OFF, FNC_SPERG_ON,
                    ...
                    FNC_LOST_OFF, FNC_LOST_ON, FNC_ROUTE_OFF, FNC_ROUTE_ON, FNC_ROUTE_RUN_OFF, FNC_ROUTE_RUN_ON, FNC_ROUTE_ADD_OFF, FNC_ROUTE_ADD_ON, FNC_ROUTE_DEL_OFF, FNC_ROUTE_DEL_ON,
                    FNC_ROUTE_EMPTY_OFF, FNC_ROUTE_EMPTY_ON,
                 };
...
const unsigned char* funcIcon[] = {
  ...
  sperrreR_off, sperrreR_on,
  sperrreG_off, sperrreG_on,
  ...
  lost_off, lost_on,
  route_off, route_on,
  route_off, route_run_on,
  route_add_off, route_add_on,
  route_add_off, route_del_on,
  route_add_off, blank32,
};
...
enum funcObj {FNC_FX0, FNC_FX1, FNC_FX2, FNC_FX3, FNC_FX4, FNC_FX5, FNC_FX6, FNC_FX7, FNC_FX8, FNC_FX9,
              ...
              FNC_NXT_WAGON, FNC_NXT_REWARD, FNC_NXT_POINTS, FNC_AUTO0, FNC_AUTO1, FNC_AUTO2, FNC_AUTO3, FNC_AUTO4,
              FNC_FTP_USER,
              MAX_FNC_OBJ
             };
...
wFncObj fncData[MAX_FNC_OBJ] = {
  ...
  {114, 150, 99, true,  FNC_FUNC_OFF, COLOR_BLACK, COLOR_YELLOW, COLOR_BACKGROUND},                 // FNC_CHG
  ...
  { 39,  64, 99, true, FNC_ROUTE_EMPTY_OFF, COLOR_BLACK,        COLOR_RED, COLOR_WHITE},            // FNC_AUTO0
  { 39, 104, 99, true, FNC_ROUTE_EMPTY_OFF, COLOR_BLACK,        COLOR_RED, COLOR_WHITE},            // FNC_AUTO1
  { 39, 144, 99, true, FNC_ROUTE_EMPTY_OFF, COLOR_BLACK,        COLOR_RED, COLOR_WHITE},            // FNC_AUTO2
  { 39, 184, 99, true, FNC_ROUTE_EMPTY_OFF, COLOR_BLACK,        COLOR_RED, COLOR_WHITE},            // FNC_AUTO3
  { 39, 224, 99, true, FNC_ROUTE_EMPTY_OFF, COLOR_BLACK,        COLOR_RED, COLOR_WHITE},            // FNC_AUTO4
  { 20,  62, 99, true, FNC_CONDUCTOR_OFF,   COLOR_SKIN_BROWN,   COLOR_RED, COLOR_GHOST_WHITE},      // FNC_FTP_USER
};
...
enum iconObj {ICON_PACO, ICON_SDCARD, ICON_NO_SD, ICON_WIFI, ICON_NO_WIFI, ICON_WIFI_SSID, ICON_WIFI_CLOSE, ICON_WIFI_CFG,
              ...
              ICON_MENU_AUTO, ICON_PREV_AUTO, ICON_NEXT_AUTO, ICON_EDIT_AUTO, ICON_AUTO_CNCL, ICON_AUTO_OPC0, ICON_AUTO_OPC1, ICON_AUTO_OPC2, ICON_AUTO_OPC3,
              ICON_AUTO_OPC4, ICON_AUTO_EDIT_INSERT, ICON_AUTO_EDIT_DEL, ICON_AUTO_EDIT_SAVE, ICON_AUTO_EDIT_CNCL, ICON_AUTO_ADD, ICON_UTL_REMOTE,
              ICON_FTP_WIFI, ICON_FTP_SD, ICON_FTP_DIR,
              MAX_ICON_OBJ
             };
...
wIconObj iconData[MAX_ICON_OBJ] = {
  ...
  { 16,  64, 24, 24, COLOR_BLACK,       sdcard},          // ICON_SDCARD
  ...
  { 33, 286, 24, 24, COLOR_BLACK,       sdcard},          // ICON_EDIT_SAVE
  {117, 290, 16, 16, COLOR_BLACK,       trash},           // ICON_EDIT_DEL
  {197, 290, 16, 16, COLOR_RED,         cancel},          // ICON_EDIT_CNCL
  ...
  {  4, 204, 32, 32, COLOR_WHITE,       route_add_off},   // ICON_MENU_AUTO
  { 15, 274, 32, 32, COLOR_BLUE,        prevP},           // ICON_PREV_AUTO
  {195, 274, 32, 32, COLOR_BLUE,        nextP},           // ICON_NEXT_AUTO
  {200,  18, 24, 24, COLOR_BLACK,       wrench},          // ICON_EDIT_AUTO
  {112, 284, 16, 16, COLOR_RED,         cancel},          // ICON_AUTO_CNCL

  { 26,  56, 24, 24, COLOR_RED,         wrench},          // ICON_AUTO_OPC0
  { 66,  56, 24, 24, COLOR_RED,         wrench},          // ICON_AUTO_OPC1
  {106,  56, 24, 24, COLOR_RED,         wrench},          // ICON_AUTO_OPC2
  {146,  56, 24, 24, COLOR_RED,         wrench},          // ICON_AUTO_OPC3
  {186,  56, 24, 24, COLOR_RED,         wrench},          // ICON_AUTO_OPC4
  { 26, 131, 24, 24, COLOR_BLACK,       auto_insert},     // ICON_AUTO_EDIT_INSERT
  { 82, 135, 16, 16, COLOR_BLACK,       trash},           // ICON_AUTO_EDIT_DEL
  {134, 131, 24, 24, COLOR_BLACK,       sdcard},          // ICON_AUTO_EDIT_SAVE
  {190, 135, 16, 16, COLOR_RED,         cancel},          // ICON_AUTO_EDIT_CNCL
  {106,  26, 24, 24, COLOR_BLACK,       wrench},          // ICON_AUTO_ADD
  {  8, 208, 24, 24, COLOR_BLACK,       sdcard},          // ICON_UTL_REMOTE
  { 55,  66, 32, 24, COLOR_BLACK,       wifi},            // ICON_FTP_WIFI
  {148,  66, 24, 24, COLOR_BLACK,       sdcard},          // ICON_FTP_SD
  {112,  70, 16, 16, COLOR_ORANGE,      arrowR},          // ICON_FTP_DIR
...
enum buttonObj {BUT_CAL_OK, BUT_SSID_CLOSE, BUT_WIFI_OK, BUT_PWD_OK, BUT_PWD_CNCL, BUT_PROT_OK, BUT_OPTIONS,
                ...
                BUT_MENU_I_DRIVE, BUT_MENU_I_ACC, BUT_MENU_I_CV, BUT_MENU_I_CFG, BUT_MENU_I_UTILS, BUT_MENU_I_AUTO,
                BUT_MENU_T_DRIVE, BUT_MENU_T_ACC, BUT_MENU_T_CV, BUT_MENU_T_CFG, BUT_MENU_T_UTILS, BUT_MENU_T_AUTO,
                ...
                BUT_UTL_I_SPEEDO, BUT_UTL_I_STEAM, BUT_UTL_I_SCAN, BUT_UTL_I_STA, BUT_UTL_I_NXT, BUT_UTL_I_REMOTE,
                BUT_UTL_T_SPEEDO, BUT_UTL_T_STEAM, BUT_UTL_T_SCAN, BUT_UTL_T_STA, BUT_UTL_T_NXT, BUT_UTL_T_REMOTE,
                ...
                BUT_CS2_UID, BUT_AUTO_CNCL, BUT_AUTO_OPC0, BUT_AUTO_OPC1, BUT_AUTO_OPC2, BUT_AUTO_OPC3, BUT_AUTO_OPC4, BUT_AUTO_EDIT_ADD, BUT_AUTO_EDIT_DEL,
                BUT_AUTO_EDIT_SAVE, BUT_AUTO_EDIT_CNCL, BUT_AUTO_ADD,
                MAX_BUT_OBJ
               };
...
wButtonObj buttonData[MAX_BUT_OBJ] = {
  ...
  { 20, 282,  50, 32, COLOR_AQUA,  COLOR_CREAM,      OBJ_ICON, ICON_EDIT_SAVE},   // BUT_EDIT_OK
  {100, 282,  50, 32, COLOR_AQUA,  COLOR_CREAM,      OBJ_ICON, ICON_EDIT_DEL},    // BUT_EDIT_DEL
  {180, 282,  50, 32, COLOR_AQUA,  COLOR_CREAM,      OBJ_ICON, ICON_EDIT_CNCL},   // BUT_EDIT_CNCL
  ...
  {  1, 201,  39, 39, COLOR_BLACK, COLOR_BLACK,      OBJ_ICON, ICON_MENU_AUTO},   // BUT_MENU_I_AUTO
  ...
  { 41, 201, 198, 39, COLOR_BLACK, COLOR_BLACK,      OBJ_LABEL, LBL_MENU_AUTO},   // BUT_MENU_T_AUTO
  ...
  {  1, 201,  39, 39, COLOR_WHITE, COLOR_WHITE,      OBJ_ICON,  ICON_UTL_REMOTE}, // BUT_UTL_I_REMOTE
  ...
  { 41, 201, 198, 39, COLOR_WHITE, COLOR_WHITE,      OBJ_LABEL, LBL_UTIL_REMOTE}, // BUT_UTL_T_REMOTE
  ...
  {190,  52,  40, 24, COLOR_BLUE,  COLOR_CREAM,      OBJ_LABEL, LBL_CS2_UID},     // BUT_CS2_UID
  { 95, 273,  50, 35, COLOR_BLACK, COLOR_CREAM,      OBJ_ICON,  ICON_AUTO_CNCL},  // BUT_AUTO_CNCL

  { 20,  50,  36, 36, COLOR_BLUE, COLOR_YELLOW,      OBJ_ICON,  ICON_AUTO_OPC0},  // BUT_AUTO_OPC0
  { 60,  50,  36, 36, COLOR_BLUE, COLOR_WHITE,       OBJ_ICON,  ICON_AUTO_OPC1},  // BUT_AUTO_OPC1
  {100,  50,  36, 36, COLOR_BLUE, COLOR_WHITE,       OBJ_ICON,  ICON_AUTO_OPC2},  // BUT_AUTO_OPC2
  {140,  50,  36, 36, COLOR_BLUE, COLOR_WHITE,       OBJ_ICON,  ICON_AUTO_OPC3},  // BUT_AUTO_OPC3
  {180,  50,  36, 36, COLOR_BLUE, COLOR_WHITE,       OBJ_ICON,  ICON_AUTO_OPC4},  // BUT_AUTO_OPC4
  //{ 20, 125,  36, 36, COLOR_BLUE, COLOR_CREAM,       OBJ_CHAR,  CHAR_AUTO_EDIT_ADD},   // BUT_AUTO_EDIT_ADD
  { 20, 125,  36, 36, COLOR_BLUE, COLOR_CREAM,       OBJ_ICON,  ICON_AUTO_EDIT_INSERT}, // BUT_AUTO_EDIT_ADD
  { 72, 125,  36, 36, COLOR_BLUE, COLOR_CREAM,       OBJ_ICON,  ICON_AUTO_EDIT_DEL},    // BUT_AUTO_EDIT_DEL
  {128, 125,  36, 36, COLOR_BLUE, COLOR_CREAM,       OBJ_ICON,  ICON_AUTO_EDIT_SAVE},   // BUT_AUTO_EDIT_SAVE
  {180, 125,  36, 36, COLOR_BLUE, COLOR_CREAM,       OBJ_ICON,  ICON_AUTO_EDIT_CNCL},   // BUT_AUTO_EDIT_CNCL
  {100,  20,  36, 36, COLOR_BLUE, COLOR_WHITE,       OBJ_ICON,  ICON_AUTO_ADD},   // BUT_AUTO_ADD
...
char autoNumBuf[5][IP_LNG + 1];
char autoNameBuf[5][NAME_LNG + 1];
char autoNameEditBuf[NAME_LNG + 1];
char autoOpcodeBuf[5][UID_LNG + 1];
char autoOpcCntBuf[PANEL_LNG + 1];
char autoAddBuf[UID_LNG + 1];
char autoConvBuf[ACC_LNG + 1];
char ftpCredentialsBuf[MAX_LABEL_LNG];
char ftpCurrFileBuf[PWD_LNG + 1];
...
enum textObj {TXT_SSID1, TXT_SSID2, TXT_SSID3, TXT_SSID4, TXT_SSID5, TXT_SSID6,
              ...
              TXT_AUTO_NUM0, TXT_AUTO_NUM1, TXT_AUTO_NUM2, TXT_AUTO_NUM3, TXT_AUTO_NUM4, TXT_AUTO_NAME0, TXT_AUTO_NAME1, TXT_AUTO_NAME2,
              TXT_AUTO_NAME3, TXT_AUTO_NAME4, TXT_AUTO_EDIT_NAME, TXT_AUTO_OPC0, TXT_AUTO_OPC1, TXT_AUTO_OPC2, TXT_AUTO_OPC3, TXT_AUTO_OPC4,
              TXT_AUTO_CNT, TXT_AUTO_ADD, TXT_AUTO_CONV, TXT_FTP, TXT_FTP_FILE,
              MAX_TXT_OBJ
             };
...
wTxtObj txtData[MAX_TXT_OBJ] = {
  ...
  {120,  52,  60, 24, COLOR_BLUE,  COLOR_BACKGROUND, COLOR_BACKGROUND, false, UID_LNG, locoEditID, FSSB9},          // TXT_EDIT_IMAGE
  ...
  { 90, 115,  80, 31, COLOR_NAVY,  COLOR_BACKGROUND, COLOR_BACKGROUND, true,  ADDR_LNG, locoEditFunc, FSSB12},      // TXT_EDIT_FNC
  ...
  {  1,  62,  34, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      true,  IP_LNG,    autoNumBuf[0], FSSB9},     // TXT_AUTO_NUM0
  {  1, 102,  34, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      true,  IP_LNG,    autoNumBuf[1], FSSB9},     // TXT_AUTO_NUM1
  {  1, 142,  34, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      true,  IP_LNG,    autoNumBuf[2], FSSB9},     // TXT_AUTO_NUM2
  {  1, 182,  34, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      true,  IP_LNG,    autoNumBuf[3], FSSB9},     // TXT_AUTO_NUM3
  {  1, 222,  34, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      true,  IP_LNG,    autoNumBuf[4], FSSB9},     // TXT_AUTO_NUM4
  { 76,  62, 160, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      false, NAME_LNG,  autoNameBuf[0], FSSB9},    // TXT_AUTO_NAME0
  { 76, 102, 160, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      false, NAME_LNG,  autoNameBuf[1], FSSB9},    // TXT_AUTO_NAME1
  { 76, 142, 160, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      false, NAME_LNG,  autoNameBuf[2], FSSB9},    // TXT_AUTO_NAME2
  { 76, 182, 160, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      false, NAME_LNG,  autoNameBuf[3], FSSB9},    // TXT_AUTO_NAME3
  { 76, 222, 160, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_WHITE,      false, NAME_LNG,  autoNameBuf[4], FSSB9},    // TXT_AUTO_NAME4

  { 20,   8, 160, 30, COLOR_BLACK, COLOR_WHITE,      COLOR_BLUE,       false, NAME_LNG,  autoNameEditBuf, FSSB9},   // TXT_AUTO_EDIT_NAME
  { 19,  86,  38, 24, COLOR_WHITE, COLOR_DARKGREY,   COLOR_DARKGREY,   true,  UID_LNG,   autoOpcodeBuf[0], FSSB9},  // TXT_AUTO_OPC0
  { 59,  86,  38, 24, COLOR_WHITE, COLOR_DARKGREY,   COLOR_DARKGREY,   true,  UID_LNG,   autoOpcodeBuf[1], FSSB9},  // TXT_AUTO_OPC1
  { 99,  86,  38, 24, COLOR_WHITE, COLOR_DARKGREY,   COLOR_DARKGREY,   true,  UID_LNG,   autoOpcodeBuf[2], FSSB9},  // TXT_AUTO_OPC2
  {139,  86,  38, 24, COLOR_WHITE, COLOR_DARKGREY,   COLOR_DARKGREY,   true,  UID_LNG,   autoOpcodeBuf[3], FSSB9},  // TXT_AUTO_OPC3
  {179,  86,  38, 24, COLOR_WHITE, COLOR_DARKGREY,   COLOR_DARKGREY,   true,  UID_LNG,   autoOpcodeBuf[4], FSSB9},  // TXT_AUTO_OPC4
  {180,   8,  58, 30, COLOR_BLACK, COLOR_BACKGROUND, COLOR_BACKGROUND, true,  PANEL_LNG, autoOpcCntBuf, FSSB9},     // TXT_AUTO_CNT
  { 80,  70,  80, 35, COLOR_BLACK, COLOR_WHITE,      COLOR_BLUE,       true,  UID_LNG,   autoAddBuf, FSSB9},        // TXT_AUTO_ADD
  {162,  70,  76, 35, COLOR_BLUE,  COLOR_BACKGROUND, COLOR_BACKGROUND, true,  ACC_LNG,   autoConvBuf, FSSB9},       // TXT_AUTO_CONV
  {  5, 130, 230, 30, COLOR_WHITE, COLOR_BLUE,       COLOR_BLUE,       false, MAX_LABEL_LNG, ftpCredentialsBuf, FSS7},   // TXT_FTP
  {  1,  95, 238, 30, COLOR_BLACK, COLOR_GHOST_WHITE, COLOR_GHOST_WHITE, true, PWD_LNG,  ftpCurrFileBuf, FSS7},     // TXT_FTP_FILE
};
...
wSwitchObj switchData[MAX_SWITCH_OBJ] = {
  ...
  { 60, 190, 21, COLOR_BLUE, COLOR_DARKCYAN,  COLOR_WHITE, false},        // SW_MOMENTARY
...
wKeybObj keybData[MAX_KEYB_OBJ] = {
  ...
  { 45, 125, KEYB_KEYPAD_BIG, TXT_AUTO_ADD},          // KEYB_AUTO
