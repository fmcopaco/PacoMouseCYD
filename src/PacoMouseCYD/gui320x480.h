...
wWinObj winData[MAX_WIN_OBJ] = {
  ...
  { 40,  80, 240, 320, true, COLOR_BLUE,  COLOR_GHOST_WHITE},  // WIN_FTP
};
...
wLabelObj labelData[MAX_LABEL_OBJ] = {
  ...
  {  85, 330, FSSB9,  COLOR_BLACK,  ML_DATUM},          // LBL_UTIL_REMOTE
  ...
  {  85, 420, FSSB9,  COLOR_WHITE,  ML_DATUM},          // LBL_MENU_AUTO
  ...
  { 160, 100, FSSB9,  COLOR_DARKRED, MC_DATUM},         // LBL_FTP
};
...
const char drwStrFTP[]       = {"K1R230,135K7X75Y295L245,295"};
...
wFncObj fncData[MAX_FNC_OBJ] = {
  ...
  { 60, 142, 99, true, FNC_CONDUCTOR_OFF,   COLOR_SKIN_BROWN,   COLOR_RED, COLOR_GHOST_WHITE},      // FNC_FTP_USER
};
...
wIconObj iconData[MAX_ICON_OBJ] = {
  ...
  { 44, 408, 32, 32, COLOR_WHITE,       route_add_off},   // ICON_MENU_AUTO
  ...
  { 48, 318, 24, 24, COLOR_BLACK,       sdcard},          // ICON_UTL_REMOTE
  { 95, 146, 32, 24, COLOR_BLACK,       wifi},            // ICON_FTP_WIFI
  {188, 146, 24, 24, COLOR_BLACK,       sdcard},          // ICON_FTP_SD
  {152, 150, 16, 16, COLOR_ORANGE,      arrowR},          // ICON_FTP_DIR
};
...
wButtonObj buttonData[MAX_BUT_OBJ] = {
  ...
  { 41, 401,  39, 39, COLOR_BLACK, COLOR_BLACK,      OBJ_ICON, ICON_MENU_AUTO},   // BUT_MENU_I_AUTO
  ...
  { 81, 401, 198, 39, COLOR_BLACK, COLOR_BLACK,      OBJ_LABEL, LBL_MENU_AUTO},   // BUT_MENU_T_AUTO
  ...
  { 41, 311,  39, 39, COLOR_WHITE, COLOR_WHITE,      OBJ_ICON,  ICON_UTL_REMOTE}, // BUT_UTL_I_REMOTE
  ...
  { 81, 311, 198, 39, COLOR_NAVY,  COLOR_WHITE,      OBJ_LABEL, LBL_UTIL_REMOTE}, // BUT_UTL_T_REMOTE
...
wTxtObj txtData[MAX_TXT_OBJ] = {
  ...
  { 45, 210, 230, 30, COLOR_WHITE, COLOR_BLUE,       COLOR_BLUE,       false, MAX_LABEL_LNG, ftpCredentialsBuf, FSS7},   // TXT_FTP
  { 41, 175, 238, 30, COLOR_BLACK, COLOR_GHOST_WHITE, COLOR_GHOST_WHITE, true, PWD_LNG,  ftpCurrFileBuf, FSS7},     // TXT_FTP_FILE
};
